...
const bookingData = {
  ...
  appointment: { // the formatted appointment object that will be used in the request to create
    "key": null, // provided by the timeslot selection
    "labOrderDetails": [ // provided by the lab order step
      {
        "contactName": null,
        "contactPhone": null,
        "labOrderFileIds": []
...
const step = {
  current: 1,
  stepSetup: { // runs when loading the step
    2: () => initTimeslots(),
    4: () => initPayment(),
    5: () => bookAppointment()
  },
